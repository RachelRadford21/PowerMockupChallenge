    ...
    var body: some View {
        ...
        VStack {
            HStack {
                ...
                TextView(title: "Power HRG", bottomPadding: 330, topPadding: 0, leadingPadding: 10, trailingPadding: 25, textSize: 22, textColor: .black)
                    .bold()
            
                TextView(title: "Company", bottomPadding: 330, topPadding: 0, leadingPadding: -5, trailingPadding: 35, textSize: 13, textColor: Color.otherGrey)
                    .bold()
                ...
                .overlay {
                    ...
                    SocialMediaStatsView(count: 768, people: 1068, textSize: 16, bottomPadding: 165, leadingPadding: 85, topPadding: 25)
